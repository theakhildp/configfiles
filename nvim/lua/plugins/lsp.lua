...
-- Ensure Bash Language Server is installed
require('mason-lspconfig').setup {
  ensure_installed = { 'bash-language-server' },  -- Add bash-language-server here
}
...
-- manualy setup of Bash with LSP
    require('lspconfig').bashls.setup({
      cmd = { 'bash-language-server', 'start' },  -- Correct command to start the server
      on_attach = on_attach,  -- Ensure the on_attach function is set up to bind keymaps
      capabilities = capabilities,  -- Ensure the capabilities are properly set
    })
